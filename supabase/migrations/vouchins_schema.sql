...
CREATE TABLE IF NOT EXISTS posts (
  ...
  text text NOT NULL,
  category text NOT NULL CHECK (category IN ('housing', 'buy_sell', 'recommendations', 'jobs')),
  visibility text NOT NULL CHECK (visibility IN ('company', 'all')),
  sub_category text CHECK (sub_category IN ('flatmates', 'rentals', 'sale', 'pg', 'hiring', 'seeking_referral', 'offering_referral', 'seeking_job')),
  image_url text,
