    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <section className="mb-12">
        ...
        <p className="text-xl text-neutral-600 leading-relaxed max-w-2xl font-medium">
          The verified professional network for trusted local recommendations
            ...
            <div>
              ...
              <div className="border-l-4 border-indigo-500 pl-4 py-1 bg-white/50 rounded-r-lg">
                <p className="font-medium text-neutral-900 italic">
                  &quot;We are developers who have faced this issue firsthand.
                  We created Vouchins to solve this problem for ourselves and
                  our colleagues.&quot;
                </p>
              </div>
            </div>
        ...
        <section className="grid md:grid-cols-2 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-lg font-medium text-neutral-800">
              To become the global go-to platform for trusted recommendations
              and transactions.
            </p>
            <p>
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              a <strong>Circle of Trust</strong>. By verifying every user via
              their professional credentials, we ensure every interaction is
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-3">
              ...
              <p className="text-sm text-neutral-600">
                Access is restricted to professionals from verified companies,
                ensuring a high-intent, high-accountability community.
              </p>
            </div>
            <div className="space-y-3">
              <div className="h-1 bg-indigo-600 w-12 rounded-full mb-4" />
              ...
              <p className="text-sm text-neutral-600">
                You control your visibility. Post exclusively for your verified
                colleagues or share with the wider professional circle.
              </p>
            </div>
            <div className="space-y-3">
              <div className="h-1 bg-indigo-600 w-12 rounded-full mb-4" />
              ...
              <p className="text-sm text-neutral-600">
                Transactions are peer-to-peer. No brokers, no hidden fees, and
                zero fake listings from anonymous accounts.
              </p>
            </div>
          </div>
        </section>
